...
public class Tablero2 {
    ...
    private int tamanioHorizontal;
        ...
        public Tablero2(Jugador jugadorAliado, Jugador jugadorEnemigo){
            this.tableroDelJuego = new ArrayList<Casillero>();
        ...
        private Casillero obtenerCasillero(int posicionX, int posicionY) {
            ...
            if(this.verificarPosicionValida(posicionX,posicionY)){
            ...
            }throw new CasilleroInexsistenteException();
        }
    ...
    private boolean verificarPosicionValida(int posicionX, int posicionY) {
        if((posicionX<= this.tamanioHorizontal)&&(posicionY<= this.tamanioVertical)) {
            return true;
